...
notes = Note.create([
  {title: 'Wonderful Note.', body: 'This note is about being a wonderful note.  It is a special note, this note.  Wonderful.', author_id: 0, notebook_id: 0},
  {title: 'Bonderful Note.', body: 'This note is about being a Bonderful note.  It is a special note, this note.  Bonderful.', author_id: 0, notebook_id: 0},
  {title: 'Vonderful Note.', body: 'This note is about being a Vonderful note.  It is a special note, this note.  Vonderful.', author_id: 0, notebook_id: 0},
  {title: 'Gonderful Note.', body: 'This note is about being a wonderful note.  It is a special note, this note.  Wonderful.', author_id: 0, notebook_id: 0},
  {title: 'Sonderful Note.', body: 'This note is about being a Sonderful note.  It is a special note, this note.  Sonderful.', author_id: 0, notebook_id: 0},
  {title: 'Xonderful Note.', body: 'This note is about being a Xonderful note.  It is a special note, this note.  Xonderful.', author_id: 0, notebook_id: 0},
